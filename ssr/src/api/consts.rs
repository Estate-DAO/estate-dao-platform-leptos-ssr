pub const PROVAB_BASE_URL_PROD: &str = "https://prod.services.travelomatix.com/webservices/index.php/hotel_v3/service/";
...
pub fn get_headers_from_env() -> HeaderMap {
    let headers: Value = serde_json::from_str(option_env!("PROVAB_HEADERS").expect("PROVAB_HEADERS must be set"))
