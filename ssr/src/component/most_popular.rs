...
// use crate::log;
// use leptos::prelude::*;
// use leptos::prelude::Signal; // <-- Add this import for `.get()` method
// use leptos_icons::*;
...
//     let (initial_date, set_initial_date) = signal((2025_u32, 1_u32, 1_u32));
...
//     let query = destinations_query().use_query(move || true);
