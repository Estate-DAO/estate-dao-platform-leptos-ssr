...
#[cfg(feature = "ga4")]
use crate::event_streaming::{send_event_ssr, send_event_ssr_spawn};
...
#[derive(Default)]
pub struct SearchedDestination;

impl SearchedDestination {
    // todo dummy event for now
    pub fn send_event(&self) {
        #[cfg(all(feature = "hydrate", feature = "ga4"))]
        {
            send_event_ssr_spawn(
                "searched_destination".to_string(),
                json!({
                    "user_id": "1234567890",
